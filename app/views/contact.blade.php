        ...
        <div class="page-contener" style="margin-top: 120px;">
            <div class="wrapper">
                <div class="content-seccion">
                    <div class="barra-info">Contacto</div>
                    <div class="info1" style="margin:0 auto;  width: 300px; display: block;">
                        <span class="span1">Sunstar Suisse S.A.</span>
                        <br/>
                        Frederic Mompou 5, 6ª 3ºB
                        <br/>
                        Sant Just Desvern, 08960, Barcelona
                        <br/><br/>
                        <span class="span1">Tel.:</span> (+34) 93 4705880
                        <br/>
                        <span class="span1">Fax:</span> (+34) 93 4700391
                        <br/>
                    </div>
                </div>
            </div>
